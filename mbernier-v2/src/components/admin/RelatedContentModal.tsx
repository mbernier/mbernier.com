        ...
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`p-1 rounded ${isSelected(item) ? 'bg-primary text-white' : 'bg-gray-100 hover:bg-gray-200'}`}
            >
        ...
        <div className="p-6 border-b">
          ...
          <div className="flex items-center gap-4 mt-4">
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium ${selectedTab === 'ai' ? 'bg-primary text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium ${selectedTab === 'clusters' ? 'bg-primary text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium ${selectedTab === 'search' ? 'bg-primary text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
            >
