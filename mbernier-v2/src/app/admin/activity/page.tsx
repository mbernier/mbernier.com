      ...
      <CardContent className="space-y-4">
        {activity.sourceUrl && (
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <a href={activity.sourceUrl} target="_blank" rel="noopener noreferrer" className="hover:text-primary">
              {activity.sourceUrl}
            </a>
          </div>
        )}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center">
                <div className="flex items-center justify-center gap-1 text-sm text-gray-600">
                  ...
                  <span className="font-medium">
                    {activity.socialMetrics.reduce((sum: number, m: any) => sum + (m.impressions || 0), 0)}
                  </span>
                </div>
              ...
              <div className="text-center">
                <div className="flex items-center justify-center gap-1 text-sm text-gray-600">
                  ...
                  <span className="font-medium">
                    {activity.socialMetrics.reduce((sum: number, m: any) => sum + (m.likes || 0), 0)}
                  </span>
                </div>
              ...
              <div className="text-center">
                <div className="flex items-center justify-center gap-1 text-sm text-gray-600">
                  ...
                  <span className="font-medium">
                    {activity.socialMetrics.reduce((sum: number, m: any) => sum + (m.shares || 0), 0)}
                  </span>
                </div>
              ...
              <div className="text-center">
                <div className="flex items-center justify-center gap-1 text-sm text-gray-600">
                  ...
                  <span className="font-medium">
                    {activity.socialMetrics.reduce((sum: number, m: any) => sum + (m.comments || 0), 0)}
                  </span>
                </div>
...
export default async function ActivityPage() {
  ...
  const { activities, socialMetrics, adminActions, aggregateMetrics } = await getActivityData();
