  ...
  return (
    <footer className={cn('bg-graphite-900 text-graphite-100', className)}>
      <div className="container-custom">
        <div className="py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div className="col-span-1 md:col-span-2 space-y-6">
              ...
              <p className="text-graphite-300 text-balance max-w-md leading-relaxed">
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-graphite-300 uppercase tracking-wider">
                Navigation
              </h3>
        ...
        {/* Bottom Bar */}
        <div className="py-8 border-t border-graphite-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-graphite-400 text-sm">
              © {currentYear} Matt Bernier. All rights reserved.
            </p>
            <div className="flex space-x-8">
              {footerLinks.legal.map((link) => (
                <Link
                  key={link.name}
                  href={link.href}
                  className="text-graphite-400 hover:text-white transition-colors duration-200 text-sm"
                >
                  {link.name}
                </Link>
              ))}
