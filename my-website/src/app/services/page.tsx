  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold mb-4">How I Can Help You</h1>
      ...
      {/* Work Arrangements */}
      <div className="mb-10">
        <h2 className="text-3xl font-bold mb-10 text-center">Working Arrangements</h2>
      </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden border border-gray-200 dark:border-gray-700 transition-all hover:shadow-lg">
          <div className="p-6">
            <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center mb-4">
              ...
              <h3 className="text-xl font-bold mb-2">Contract Based</h3>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden border border-gray-200 dark:border-gray-700 transition-all hover:shadow-lg">
          <div className="p-6">
            <div className="w-12 h-12 bg-green-100 dark:bg-green-900/30 rounded-lg flex items-center justify-center mb-4">
              ...
              <h3 className="text-xl font-bold mb-2">Fractional Leadership</h3>
              <p className="text-gray-400 dark:text-gray-400 mb-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden border border-gray-200 dark:border-gray-700 transition-all hover:shadow-lg">
          <div className="p-6">
            <div className="w-12 h-12 bg-green-100 dark:bg-green-900/30 rounded-lg flex items-center justify-center mb-4">
              ...
              <h3 className="text-xl font-bold mb-2">Full-Time Roles</h3>
              <p className="text-gray-400 dark:text-gray-400 mb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden border border-gray-200 dark:border-gray-700 transition-all hover:shadow-lg">
          <div className="p-6">
            ...
            <h3 className="text-xl font-bold mb-2">Product Leadership</h3>
            <p className="text-gray-400 dark:text-gray-400 mb-4">
              Strategic guidance to define, validate, and deliver successful products that meet market needs.
            </p>
            <ul className="text-gray-400 dark:text-gray-400 list-disc list-inside space-y-1 mb-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden border border-gray-200 dark:border-gray-700 transition-all hover:shadow-lg">
          <div className="p-6">
            ...
            <h3 className="text-xl font-bold mb-2">Education & Knowledge Sharing</h3>
            <p className="text-gray-400 dark:text-gray-400 mb-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden border border-gray-200 dark:border-gray-700 transition-all hover:shadow-lg">
          <div className="p-6">
            ...
            <h3 className="text-xl font-bold mb-2">Fractional CPO Services</h3>
            <p className="text-gray-400 dark:text-gray-400 mb-4">
